...
export const register = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(201, user, "User register succesfully"));
});
...
export const login = asyncHandler(async (req, res) => {
  ...
  if (!isPasswordCorrect)
    throw new ApiError(400, "Worng Password Access Denied");
  ...
  return res
    ...
    .json(new ApiResponse(200, loggedInUser, "User logged in succesfull"));
});
